      ...
      <div class="offcanvas offcanvas-end" tabindex="-1" id="Navbar">
        ...
        <div class="offcanvas-body">
          <ul class="navbar-nav me-auto">
            <li
              v-if="identity.includes('Instructor') || identity.includes('TA')"
              class="nav-item"
              data-bs-dismiss="offcanvas"
            >
              <RouterLink class="nav-link" to="/teacher/milestone_management"
                >Milestone Management</RouterLink
              >
            </li>
            <li
              v-if="identity.includes('Instructor') || identity.includes('TA')"
              ...
              data-bs-dismiss="offcanvas"
            >
              <RouterLink class="nav-link" to="/teacher/team_management"
                >Team Management</RouterLink
              >
            </li>

            <li
              v-if="identity.includes('Student')"
              class="nav-item"
              data-bs-dismiss="offcanvas"
            >
              <RouterLink class="nav-link" to="/student/milestone_management"
                >Milestone Management</RouterLink
              >
            </li>
            <li
              ...
              data-bs-dismiss="offcanvas"
            >
              <RouterLink class="nav-link" to="/student/notification_management"
                >Notification Management</RouterLink
              >
            </li>
          ...
          <ul class="navbar-nav ms-auto">
            <li
              v-if="!identity.includes('Unauthenticated')"
              class="nav-item"
              data-bs-dismiss="offcanvas"
            >
              <a
                class="nav-link pointer-link"
                @click="access_type_change('Logout')"
              >
            ...
            >
              <a
                class="nav-link pointer-link"
                @click="access_type_change('Login')"
                >Login</a
              >
            </li>
          </ul>
