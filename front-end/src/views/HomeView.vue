  ...
  <div>
    ...
    <section class="hero-section text-white py-5">
      <div class="container">
        <div class="row py-5">
          <div class="col-md-8">
            <h1 class="display-4 fw-bold mb-4">Efficiently Monitor Academic Projects</h1>
            <p class="lead mb-4">
              A dedicated platform with AI-driven insights and collaboration tools, built exclusively for educational
              institutions.
            </p>
            <div class="d-flex gap-3">
              <button v-if="identity.includes('Unauthenticated')" class="btn btn-light btn-lg"
                @click="access_type_change()">Sign in</button>
    ...
    <section class="py-5">
      <div class="container">
        <h2 class="text-center mb-5">For Academia</h2>
        <div class="row g-4">
