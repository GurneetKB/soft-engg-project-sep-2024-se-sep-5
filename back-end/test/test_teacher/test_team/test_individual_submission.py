...
def client(scope="module"):
    ...
    with app.test_client() as client:
        yield client
    if os.path.exists("instance/testing.sqlite3"):
        os.remove("instance/testing.sqlite3")


@pytest.fixture
def student_token(client, scope="module"):
...
@pytest.fixture
def instructor_token(client, scope="module"):
    response = client.post(
        "/login?include_auth_token",
